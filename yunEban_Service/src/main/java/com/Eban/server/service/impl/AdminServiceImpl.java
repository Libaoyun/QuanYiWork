...
import com.Eban.server.mapper.AdminMapper;
import com.Eban.server.mapper.AdminRoleMapper;
import com.Eban.server.mapper.RoleMapper;
...
import com.Eban.server.utils.CurrentAdminUtil;
...
//        注意这里是  !passwordEncoder.match！！！这里只是密码加密，而不是token加密那么复杂
...
//        admin = adminMapper.selectOne(new QueryWrapper<Admin>().eq("username",username).eq("enabled",true));
//        System.out.println(admin);
    ...
    public List<Admin> getAllAdmins(String keywords) {
        ...
        return adminMapper.getAllAdmins(CurrentAdminUtil.getCurrentAdmin().getId(), keywords);
    }
