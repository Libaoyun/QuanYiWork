...
//        设置生成到哪个模块的文件夹下***************************
        gc.setOutputDir(projectPath + "/yunEban_generator/src/main/java");
        gc.setAuthor("LBY");
        gc.setOpen(false);
//        XML开启resultMap***************************
...
//        这里只代表创建后文件头上面显示的包路径，而不是代表实际的位置，实际位置已经在上面定义过了
        pc.setParent("com.Eban.generator")
            .setEntity("pojo")
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/yunEban_generator/src/main/resources/mapper/"
